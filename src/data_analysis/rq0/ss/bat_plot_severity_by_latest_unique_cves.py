...
# Read the CSV file
df = pd.read_csv("data/latest_releases_cves_with_existence.csv")
df = df[df["Exists_in_latest_releases"] == True]
...
df["Severity_Mapped"] = df["cve_severity"].map(severity_mapping)
