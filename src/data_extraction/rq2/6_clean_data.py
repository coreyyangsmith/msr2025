...
df = pd.read_csv("data/rq2_5_metrics_availability.csv", index_col=0)
...
df_cleaned.index.to_series().to_csv(
    "data/rq2_6_cleaned_metrics_repos.csv", header=False, index=False
)
print(
    f"\nSaved cleaned dataset with {len(df_cleaned)} repositories to rq2_6_cleaned_metrics_repos.csv"
)
